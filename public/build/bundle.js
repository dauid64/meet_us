...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 22, 4, 437);
    			attr_dev(header, "class", "svelte-1qeq5a6");
    			add_location(header, file$3, 21, 0, 423);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1dp9d2m");
    			add_location(h1, file$2, 64, 8, 973);
    			attr_dev(h2, "class", "svelte-1dp9d2m");
    			add_location(h2, file$2, 65, 8, 999);
    			attr_dev(p0, "class", "svelte-1dp9d2m");
    			add_location(p0, file$2, 66, 8, 1028);
    			attr_dev(header, "class", "svelte-1dp9d2m");
    			add_location(header, file$2, 63, 4, 955);
    			if (!src_url_equal(img.src, img_src_value = /*imageUrl*/ ctx[2])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*title*/ ctx[0]);
    			attr_dev(img, "class", "svelte-1dp9d2m");
    			add_location(img, file$2, 69, 8, 1094);
    			attr_dev(div0, "class", "image svelte-1dp9d2m");
    			add_location(div0, file$2, 68, 4, 1065);
    			attr_dev(p1, "class", "svelte-1dp9d2m");
    			add_location(p1, file$2, 72, 8, 1179);
    			attr_dev(div1, "class", "content svelte-1dp9d2m");
    			add_location(div1, file$2, 71, 4, 1148);
    			attr_dev(a, "href", a_href_value = "mailto:" + /*email*/ ctx[5]);
    			add_location(a, file$2, 76, 8, 1288);
    			add_location(button0, file$2, 77, 8, 1334);
    			add_location(button1, file$2, 78, 8, 1373);
    			attr_dev(footer, "class", "svelte-1dp9d2m");
    			add_location(footer, file$2, 74, 4, 1217);
    			attr_dev(article, "class", "svelte-1dp9d2m");
    			add_location(article, file$2, 62, 0, 940);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$1, 21, 0, 374);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 35, 0, 1119);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, MeetUpGrid: MeetupGrid, meetups });
    	return [meetups];
    }
