    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 22, 4, 437);
    			attr_dev(header, "class", "svelte-1qeq5a6");
    			add_location(header, file$5, 21, 0, 423);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-1i3gaew"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$4, 88, 4, 1647);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mode*/ 8 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-1i3gaew"))) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 86, 4, 1602);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 71, 6, 1046);
    			attr_dev(h2, "class", "svelte-1fuebm9");
    			add_location(h2, file$3, 72, 6, 1070);
    			attr_dev(p0, "class", "svelte-1fuebm9");
    			add_location(p0, file$3, 73, 6, 1097);
    			attr_dev(header, "class", "svelte-1fuebm9");
    			add_location(header, file$3, 70, 2, 1030);
    			...
    			add_location(img, file$3, 76, 6, 1157);
    			attr_dev(div0, "class", "image svelte-1fuebm9");
    			add_location(div0, file$3, 75, 2, 1130);
    			attr_dev(p1, "class", "svelte-1fuebm9");
    			add_location(p1, file$3, 79, 6, 1236);
    			attr_dev(div1, "class", "content svelte-1fuebm9");
    			add_location(div1, file$3, 78, 2, 1207);
    			attr_dev(footer, "class", "svelte-1fuebm9");
    			add_location(footer, file$3, 81, 2, 1270);
    			attr_dev(article, "class", "svelte-1fuebm9");
    			add_location(article, file$3, 69, 0, 1017);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 66, 4, 1746);
    			attr_dev(main, "class", "svelte-1k5t77g");
    			add_location(main, file, 65, 0, 1735);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
