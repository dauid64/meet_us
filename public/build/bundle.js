    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 76, 6, 1184);
    			attr_dev(h2, "class", "svelte-1fuebm9");
    			add_location(h2, file$3, 77, 6, 1208);
    			attr_dev(p0, "class", "svelte-1fuebm9");
    			add_location(p0, file$3, 78, 6, 1235);
    			attr_dev(header, "class", "svelte-1fuebm9");
    			add_location(header, file$3, 75, 2, 1168);
    			...
    			add_location(img, file$3, 81, 6, 1295);
    			attr_dev(div0, "class", "image svelte-1fuebm9");
    			add_location(div0, file$3, 80, 2, 1268);
    			attr_dev(p1, "class", "svelte-1fuebm9");
    			add_location(p1, file$3, 84, 6, 1374);
    			attr_dev(div1, "class", "content svelte-1fuebm9");
    			add_location(div1, file$3, 83, 2, 1345);
    			attr_dev(footer, "class", "svelte-1fuebm9");
    			add_location(footer, file$3, 86, 2, 1408);
    			attr_dev(article, "class", "svelte-1fuebm9");
    			add_location(article, file$3, 74, 0, 1155);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
